           ...
           <h2 className='font-medium text-2xl flex justify-between items-center'>
             ...
             {currState === "Sign up" && !isDataSubmitted && (
               <input onChange={(e)=>setFullName(e.target.value)} value={fullName}
                type="text" className='p-2 border border-b-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500' placeholder="Full Name" required/>
             )}
             {!isDataSubmitted && (
              <>
...

             {
              currState==="Sign up" && isDataSubmitted && (
                ...
                rows={4} className='p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-indigo-500' 
